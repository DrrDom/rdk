...
def prep_input(fname, id_field_name, tetrahedral, double_bond, max_undef):
    for mol, mol_name in read_input(fname, id_field_name):
...
def main_params(in_fname, out_fname, tetrahedral, double_bond, max_undef, id_field_name, ncpu):
...
def main():
    ...
    main_params(in_fname, out_fname, tetrahedral, double_bond, max_undef, id_field_name, ncpu)
